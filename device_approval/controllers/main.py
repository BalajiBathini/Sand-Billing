...
class DeviceApprovalHome(Home):
    ...
    def web_login(self, redirect=None, **kw):
        ...
        if device.status == 'pending':
            error_msg = _('Your login went for approval. Please wait for a few minutes or call the head number.')
        else:
            error_msg = _('Access from this device has been rejected. Please contact your administrator.')

        # Render login page with error natively
